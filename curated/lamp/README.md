...
```console
$ helm install --name my-release <helm-repo>/lamp
```
...
```console
$ helm install -f examples/wordpress.yaml --name wordpress <helm-repo>/lamp
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/lamp
```
