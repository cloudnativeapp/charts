...
```bash
$ helm install --name my-release <helm-repo>/spring-cloud-data-flow
```
...
```bash
$ helm install --name my-release --set server.service.type=NodePort <helm-repo>/spring-cloud-data-flow
```
