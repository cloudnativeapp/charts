...
```console
$ helm install <helm-repo>/phpmyadmin
```
...
```console
$ helm install --name my-release <helm-repo>/phpmyadmin
```
...
$ helm install --name my-release \
  --set db.host=mymariadb,db.port=3306 <helm-repo>/phpmyadmin
```
$ helm install --name my-release \
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/phpmyadmin
```
