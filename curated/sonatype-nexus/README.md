...
```bash
$ helm install <helm-repo>/sonatype-nexus
```
...
```bash
$ helm install --name my-release --set persistence.enabled=false <helm-repo>/sonatype-nexus
```
...
```bash
$ helm install --name my-release -f my-values.yaml <helm-repo>/sonatype-nexus
```
