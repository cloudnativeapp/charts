...
```console
$ helm install --name my-release <helm-repo>/tomcat
```
...
$ helm install --name my-release \
  --set tomcatUser=manager,tomcatPassword=password <helm-repo>/tomcat
```
$ helm install --name my-release \
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/tomcat
```
