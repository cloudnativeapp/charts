...
```console
$ helm install <helm-repo>/prometheus-pushgateway
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-pushgateway
```
...
$ helm install --name my-release \
  --set serviceAccount.name=pushgateway  \
    <helm-repo>/prometheus-pushgateway
$ helm install --name my-release \
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-pushgateway
```
