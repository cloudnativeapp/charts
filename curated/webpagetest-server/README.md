...
```console
$ helm install <helm-repo>/webpagetest-server
```
...
```console
$ helm install --name my-release <helm-repo>/webpagetest-server
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/webpagetest-server
```
