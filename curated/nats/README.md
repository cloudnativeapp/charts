...
```bash
$ helm install --name my-release <helm-repo>/nats
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/nats
```
...
$ helm install --name my-release -f ./values-production.yaml <helm-repo>/nats
```
