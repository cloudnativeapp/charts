...
```bash
$ helm install <helm-repo>/elasticsearch-exporter
```
...
```bash
$ helm install --name my-release <helm-repo>/elasticsearch-exporter
```
...
$ helm install --name my-release \
    ...
    <helm-repo>/elasticsearch-exporter
$ helm install --name my-release \
```
...
```bash
# example for staging
$ helm install --name my-release -f values.yaml <helm-repo>/elasticsearch-exporter
```
