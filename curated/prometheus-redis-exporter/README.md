...
```bash
$ helm install <helm-repo>/prometheus-redis-exporter
```
...
```bash
$ helm install --name my-release <helm-repo>/prometheus-redis-exporter
```
...
$ helm install --name my-release \
  --set "redisAddress=redis://myredis:6379" \
    <helm-repo>/prometheus-redis-exporter
$ helm install --name my-release \
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-redis-exporter
```
