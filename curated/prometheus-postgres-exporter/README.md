...
```console
$ helm install <helm-repo>/prometheus-postgres-exporter
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-postgres-exporter
```
...
$ helm install --name my-release \
  --set serviceAccount.name=postgres  \
    <helm-repo>/prometheus-postgres-exporter
$ helm install --name my-release \
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-postgres-exporter
```
