...
```bash
$ helm install <helm-repo>/prometheus-blackbox-exporter
```
...
```bash
$ helm install --name my-release <helm-repo>/prometheus-blackbox-exporter
```
...
$ helm install --name my-release \
    ...
    <helm-repo>/prometheus-blackbox-exporter
$ helm install --name my-release \
```
...
```bash
# example for staging
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-blackbox-exporter
```
