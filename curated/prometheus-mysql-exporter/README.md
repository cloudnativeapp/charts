...
```console
$ helm install <helm-repo>/prometheus-mysql-exporter
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-mysql-exporter --set mysql.user="username",mysql.pass="password",mysql.host="example.com",mysql.port="3306"
```
...
$ helm install --name my-release \
  --set mysql.user="username",mysql.password="password",mysql.host="localhost",mysql.port="3306"  \
    <helm-repo>/prometheus-mysql-exporter
$ helm install --name my-release \
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-mysql-exporter
```
