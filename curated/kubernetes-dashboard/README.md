...
```console
helm install <helm-repo>/kubernetes-dashboard
```
...
```console
helm install <helm-repo>/kubernetes-dashboard --name my-release
```
...
```console
helm install <helm-repo>/kubernetes-dashboard --name my-release -f values.yaml
```
