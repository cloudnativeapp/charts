...
```console
$ helm install --name my-release <helm-repo>/prometheus-adapter
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-adapter
```
