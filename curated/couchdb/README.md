...
```bash
$ helm install <helm-repo>/couchdb --set allowAdminParty=true
```
...
```bash
$ helm install --name my-release <helm-repo>/couchdb
```
...
```bash
$ helm install --name my-release --set createAdminSecret=false <helm-repo>/couchdb
```
