...
```console
$ helm install <helm-repo>/external-dns
```
...
```console
$ helm install --name my-release <helm-repo>/external-dns
```
...
$ helm install --name my-release \
  --set auth.rootPassword=secretpassword <helm-repo>/external-dns
```
$ helm install --name my-release \
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/external-dns
```
