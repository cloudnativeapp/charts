...
```console
$ helm install <helm-repo>/quassel
```
...
```console
$ helm install <helm-repo>/quassel --name my-release
```
...
```console
$ helm install <helm-repo>/quassel --name my-release -f values.yaml
```
...
1. Install the chart
```bash
$ helm install <helm-repo>/quassel --set persistence.existingClaim=PVC_NAME
```
