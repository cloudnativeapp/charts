...
```bash
$ helm install <helm-repo>/redmine
```
...
```bash
$ helm install --name my-release <helm-repo>/redmine
```
...
```
helm install --name my-release <helm-repo>/redmine --set databaseType.mariadb=false,databaseType.postgresql=true
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/redmine
```
