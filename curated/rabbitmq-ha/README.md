...
```bash
$ helm install <helm-repo>/rabbitmq-ha
```
...
```bash
$ helm install --name my-release <helm-repo>/rabbitmq-ha
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/rabbitmq-ha
```
...
```
$ helm install --name my-release --set existingConfigMap=true <helm-repo>/rabbitmq-ha
```
