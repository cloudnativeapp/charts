...
```bash
$ helm install <helm-repo>/prometheus-rabbitmq-exporter
```
...
```bash
$ helm install --name my-release <helm-repo>/prometheus-rabbitmq-exporter
```
...
$ helm install --name my-release \
  --set "rabbitmq.url=http://myrabbit:15672" \
    <helm-repo>/prometheus-rabbitmq-exporter
$ helm install --name my-release \
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-rabbitmq-exporter
```
