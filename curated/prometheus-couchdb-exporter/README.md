...
```bash
$ helm install <helm-repo>/prometheus-couchdb-exporter
```
...
```bash
$ helm install --name my-release <helm-repo>/prometheus-couchdb-exporter
```
...
$ helm install --name my-release \
  --set "couchdb.uri=http://mycouchdb:5984" \
    <helm-repo>/prometheus-couchdb-exporter
$ helm install --name my-release \
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/prometheus-couchdb-exporter
```
