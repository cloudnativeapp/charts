...
```console
$ helm install <helm-repo>/webpagetest-agent
```
...
```console
$ helm install --name my-release <helm-repo>/webpagetest-agent
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/webpagetest-agent
```
