...
helm install --namespace "graylog" -n "graylog" <helm-repo>/graylog
```
...
```bash
helm install --namespace "graylog" -n "mongodb" <helm-repo>/mongodb-replicaset
```
...
```bash
helm install --namespace "graylog" -n "elasticsearch" <helm-repo>/elasticsearch
```
...
```bash
helm install --namespace "graylog" -n "graylog" --set graylog.replicas=5 <helm-repo>/graylog
```
