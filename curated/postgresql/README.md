...
```console
$ helm install <helm-repo>/postgresql
```
...
```console
$ helm install --name my-release <helm-repo>/postgresql
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/postgresql
```
...
```console
$ helm install --name my-release -f ./values-production.yaml <helm-repo>/postgresql
