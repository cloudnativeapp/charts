...
```bash
$ helm install --name my-release <helm-repo>/percona-xtradb-cluster
```
...
$ helm install --name my-release \
  --set mysqlRootPassword=secretpassword,mysqlUser=my-user,mysqlPassword=my-password,mysqlDatabase=my-database \
    <helm-repo>/percona-xtradb-cluster
$ helm install --name my-release \
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/percona-xtradb-cluster
```
