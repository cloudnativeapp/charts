...
```bash
$ helm install <helm-repo>/mongodb
```
...
```bash
$ helm install --name my-release <helm-repo>/mongodb
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/mongodb
```
...
```bash
$ helm install --name my-release <helm-repo>/mongodb --set replicaSet.enabled=true
```
...
$ helm install --name my-release -f ./values-production.yaml <helm-repo>/mongodb
```
