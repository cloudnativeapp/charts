...
```bash
$ helm install <helm-repo>/stackdriver-exporter --set stackdriver.projectId=google-project-name
```
...
```bash
$ helm install --name my-release <helm-repo>/stackdriver-exporter --set stackdriver.projectId=google-project-name
```
...
$ helm install --name my-release \
    ...
    <helm-repo>/stackdriver-exporter
$ helm install --name my-release \
```
...
```bash
# example for staging
$ helm install --name my-release -f values.yaml <helm-repo>/stackdriver-exporter
```
