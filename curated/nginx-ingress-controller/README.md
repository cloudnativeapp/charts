...
```bash
$ helm install <helm-repo>/nginx-ingress-controller
```
...
```bash
$ helm install --name my-release <helm-repo>/nginx-ingress-controller
```
...
$ helm install --name my-release \
  --set controller.image.pullPolicy=Always \
    <helm-repo>/nginx-ingress-controller
$ helm install --name my-release \
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/nginx-ingress-controller
```
