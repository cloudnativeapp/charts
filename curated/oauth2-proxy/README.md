...
```console
$ helm install <helm-repo>/oauth2-proxy
```
...
```console
$ helm install <helm-repo>/oauth2-proxy --name my-release
```
...
```console
$ helm install <helm-repo>/oauth2-proxy --name my-release -f values.yaml
```
