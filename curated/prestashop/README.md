...
```console
$ helm install <helm-repo>/prestashop
```
...
```console
$ helm install --name my-release <helm-repo>/prestashop
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/prestashop
```
