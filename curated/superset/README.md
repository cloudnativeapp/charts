...
```bash
$ helm install <helm-repo>/superset
```
...
```bash
$ helm install --name my-release <helm-repo>/superset
```
...
```bash
$ helm install --set persistence.enabled=true,persistence.existingClaim=superset-pvc <helm-repo>/superset
```
