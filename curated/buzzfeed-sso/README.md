...
```bash
$ helm install --name my-release <helm-repo>/buzzfeed-sso
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/buzzfeed-sso
```
...
```bash
$ helm install --name my-release -f values.yaml -f secrets.yaml <helm-repo>/buzzfeed-sso
```
