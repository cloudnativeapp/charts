...
```console
$ helm install <helm-repo>/keycloak-proxy
```
...
```console
$ helm install --name keycloak-proxy <helm-repo>/keycloak-proxy
```
...
```bash
$ helm install --name keycloak-proxy -f values.yaml <helm-repo>/keycloak-proxy
```
