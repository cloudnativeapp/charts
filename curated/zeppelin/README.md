...
```
$ helm install <helm-repo>/zeppelin
```
...
```
helm install -n hadoop <helm-repo>/hadoop
helm install --set hadoop.useConfigMap=true,hadoop.configMapName=hadoop-hadoop <helm-repo>/zeppelin
```
