...
```bash
$ helm install --name my-release <helm-repo>/nginx
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/nginx
```
...
```console
$ helm install --name my-release -f custom-server-block.yaml <helm-repo>/nginx
```
