...
```console
$ helm install --namespace pachyderm --name my-release <helm-repo>/pachyderm
```
...
```console
$ helm install --namespace pachyderm --name my-release -f values.yaml <helm-repo>/pachyderm
```
