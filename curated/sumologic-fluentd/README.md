...
$ helm install --name my-release \
    --set sumologic.collectorUrl=YOUR-URL-HERE <helm-repo>/sumologic-fluentd
```
$ helm install --name my-release \
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/sumologic-fluentd
```
...
```console
$ helm install --name my-release <helm-repo>/sumologic-fluentd --set rbac.create=true
```
