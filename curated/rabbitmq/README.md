...
```bash
$ helm install <helm-repo>/rabbitmq
```
...
```bash
$ helm install --name my-release <helm-repo>/rabbitmq
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/rabbitmq
```
...
```bash
$ helm install --name my-release -f values-production.yaml <helm-repo>/rabbitmq
```
