...
```console
$ helm install <helm-repo>/nfs-server-provisioner
```
...
```console
$ helm install <helm-repo>/nfs-server-provisioner --name my-release
```
...
```console
$ helm install <helm-repo>/nfs-server-provisioner --name my-release -f values.yaml
```
