...
```console
$ helm install <helm-repo>/jasperreports
```
...
```console
$ helm install --name my-release <helm-repo>/jasperreports
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/jasperreports
```
