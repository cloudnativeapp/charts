# kubernetes-dashboard-tls

[Kubernetes Dashboard](https://github.com/kubernetes/dashboard) is a general purpose, web-based UI for Kubernetes clusters. It allows users to manage applications running in the cluster and troubleshoot them, as well as manage the cluster itself.

This chart bootstraps a [Kubernetes Dashboard](https://github.com/kubernetes/dashboard) deployment with an auto-generated TLS certificate on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.

## Installation
### Download the chart

First, download `kubernetes-dashboard-tls` helm chart code:

```
git clone https://github.com/cloudnativeapp/charts.git
git checkout master
cd submitted/kubernetes-dashboard-tls
```

### Install the chart

Then, install the chart with the release name `kubernetes-dashboard-tls`:

```console
helm install kubernetes-dashboard-tls .
```
...
To uninstall the `kubernetes-dashboard-tls` deployment:

```console
helm uninstall kubernetes-dashboard-tls
```
...
| `ingress.tls`                       | Ingress TLS configuration. A TLS certificate will be generated automatically by default.                                                                                                   | `{}`                                                                       |
...
```console
helm install kubernetes-dashboard -f values.yaml .
```
